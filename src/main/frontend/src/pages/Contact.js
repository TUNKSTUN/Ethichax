...
const Contact = () => {
  return (
    <div className="flex bg-transparent h-screen w-full ">
      <div className="xl:w-1/4 lg:w-1/5 h-1/4">ok</div>

    <div className=" w-full p-10 flex-col xl:text-start lg:text-start text-center text-2xl  text-stone-900 xl:w-3/4 lg:w-4/5 h-full xl:mt-0 lg:mt-0 flex top-0 right-0 xl:py-36 pt-40 font-Epilogue">
      <h1 className="text-5xl drop-shadow-md font-bold tracking-widest ">Contact:</h1>
    <br/>

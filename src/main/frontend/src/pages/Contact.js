...
const Contact = () => {
  return (
    ...
    <div className=" w-full p-8 flex-col xl:text-start lg:text-start text-center text-xl  text-stone-900 xl:w-4/5 lg:w-4/5 h-full xl:mt-0 lg:mt-0 flex top-0 right-0 xl:py-36 pt-40 font-Epilogue  bg-stone-300">
